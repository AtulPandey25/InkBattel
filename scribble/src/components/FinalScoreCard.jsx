...
const FinalScoreCard = ({ players = [] }) => {
  ...
  return (
    <div
      className="paper-card w-full flex flex-col"
      style={{ maxWidth: '800px', margin: 0, maxHeight: '85dvh' }}
    >
      {/* Scrollable Content */}
      <div
      ...
      >
        ...
        {remaining.length > 0 && (
          <div className="mt-8 border-t-2 border-black pt-4 px-4">
      ...
      <div className="border-t-2 border-black pt-4 pb-4 px-4 flex gap-4 justify-center shrink-0 bg-white">
        <button
          onClick={handleExit}
